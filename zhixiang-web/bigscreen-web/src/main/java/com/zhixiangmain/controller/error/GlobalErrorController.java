package com.zhixiangmain.controller.error;

import com.zhixiangmain.web.ExceptionEnum;
import com.zhixiangmain.web.Result;
...
public class GlobalErrorController extends AbstractErrorController {
	...
	public ModelAndView toMyErrorHtml(HttpServletRequest request) {
		...
		System.out.println("init---------------------------------------------my error page");
		return mv;
	}
