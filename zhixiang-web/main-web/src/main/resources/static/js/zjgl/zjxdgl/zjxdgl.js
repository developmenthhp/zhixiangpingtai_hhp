...
var ajaxSCJCXXSearchFormOption = {
    ...
    url: "/humiture/getHumMonthBySdId", //默认是form的action， 如果申明，则会覆盖
...
$(function(){
    ...
    $("#liParent116").children(":eq(1)").children(":eq(3)").children(":eq(0)").trigger("click");
    $("#liParent116").children(":eq(1)").children(":eq(3)").children(":eq(1)").children(":eq(1)").find("a").css("color","#FFD600");
