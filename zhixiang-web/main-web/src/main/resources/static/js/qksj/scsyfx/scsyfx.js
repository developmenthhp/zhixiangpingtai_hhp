        ...
        if(data.rows!=null){
            ...
            $.each(data.rows,function (ind,val) {
                ...
                $("#userListUl").append("<li>" +
                    ...
                    "<figcaption onclick='showUseLoginStep("+"\""+foodName+"\")'>" +
...
function showUseLoginStep(foodName) {
    window.location.href="/bioFood/getIBUNLBySdIdName?ingredientName="+foodName+"&sdIdStr="+$("#select1").val();
}
