...
$(function(){
    ...
    $("#liParent116").children(":eq(1)").children(":eq(2)").children(":eq(1)").children(":eq(2)").find("a").css("color","#FFD600");
    ...
    var socket =  io.connect('http://192.168.1.106:4001', {
    ...
    socket.on('connect', function() {
        ...
        console.log('<span class="connect-msg">Client send {"event": "sub", "channel": "channel_1"}</span>');
    });
