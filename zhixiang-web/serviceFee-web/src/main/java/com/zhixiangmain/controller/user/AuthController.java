...
public class AuthController {
	...
	public ResultBean getRoleList(@RequestParam("page") Integer page,
		...
		return authService.roleList(roleDTO,page,limit);
	}
	...
	public ResultBean setRole(@RequestParam("rolePermIds") String permIds, Role role) {
		...
		try {
			...
			String msg = authService.updateRole(role,permIds);
	...
	public Map<String,Object> getRoles() {
		...
		try {
			...
			roles = this.authService.getRoles(sdId);

			siteRoles = this.siteService.getSiteRoles(sdId);
