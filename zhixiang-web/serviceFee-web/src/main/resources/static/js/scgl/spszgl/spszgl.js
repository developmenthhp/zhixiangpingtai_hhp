...
var ajaxSCJCXXSearchFormOption = {
    ...
    url: "/cableTicketCard/getCTCBySdId", //默认是form的action， 如果申明，则会覆盖
...
$(function(){
    ...
    $("#liParent116").children(":eq(1)").children(":eq(1)").children(":eq(1)").children(":eq(0)").find("a").css("color","#FFD600");
