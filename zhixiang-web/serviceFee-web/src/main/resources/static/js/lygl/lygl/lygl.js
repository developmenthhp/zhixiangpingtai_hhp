...
$(function(){
    ...
    $("#liParent116").children(":eq(1)").children(":eq(5)").children(":eq(0)").trigger("click");
    $("#liParent116").children(":eq(1)").children(":eq(5)").children(":eq(1)").children(":eq(0)").find("a").css("color","#FFD600");
