    ...
    for(var i=0;i < data.length;i++){
        ...
        if( node.istype==0){
            ...
            if(node.pid==0){
                ...
                var ul=$("<li id='liParent"+node.id+"' class='treeview' style='border: none;'><a href='javascript:void(0)' onclick='addActClass(this)'><i class='fa fa-asterisk'></i> <span>"+node.name+"</span><i class='fa fa-angle-left pull-right'></i></a></li>");
                ...
                if(childArry.length>0){
                    ...
                    for (var y in childArry) {
                        ...
                        var thirdLi = $("<li id='liParent"+childArry[y].id+"' style='border: none;'><a href='"+childArry[y].page+"'><i class='fa fa-angle-double-right'></i>"+childArry[y].name+"</a></li>");
                ...
                if(childArry.length>0){
                    ...
                    $.each(childArry,function(ind,val){
                        var thirdLi = $("<li id='liParent"+val.id+"' style='border: none;'><a href='"+val.page+"'><i class='fa fa-stack-overflow'></i>"+val.name+"</a></li>");
                        secUl.append(thirdLi);
                    });
