package com.zhixiangmain.impl.zhjg.twjcgl;
...
import com.zhixiangmain.api.service.zhjg.twjcgl.TemperatureService;
 ...
 * @Package com.zhixiangyun.impl.zhjg.twjcgl
 * @Description: ${todo}
 * @author: hhp
 ...
 */
@Service(version = "1.0.0", interfaceClass = TemperatureService.class)
public class TemperatureServiceImpl implements TemperatureService {
    ...
    @Override
    public ResultBean getTemperatureBySdId(TemperatureDTO temperatureDTO, JSONObject jobj) {
        ...
        if(!IsEmptyUtils.isEmpty(temperatureDTO)){
            if(!IsEmptyUtils.isEmpty(temperatureDTO.getSelectYear())&&!IsEmptyUtils.isEmpty(temperatureDTO.getSelectMonth())){
                //都不为空
                temperatureDTO.setSelectYearMonth(temperatureDTO.getSelectYear()+temperatureDTO.getSelectMonth());
            }else if(IsEmptyUtils.isEmpty(temperatureDTO.getSelectYear())&&IsEmptyUtils.isEmpty(temperatureDTO.getSelectMonth())){
                //都为空
                //都不为空
                SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyyMM");
                temperatureDTO.setSelectYearMonth(simpleDateFormat.format(new Date()));
            }
        }
        if(!IsEmptyUtils.isEmpty(temperatureDTO.getSdIds())){
            String[] sdIds = temperatureDTO.getSdIds().split(",");
            for(String sdId:sdIds){
                ...
                if(!IsEmptyUtils.isEmpty(dataSourceName)){
                    ...
                    temperatureDTO2.setSomtempStart(null);
            ...
            //查询该用户所拥有的站点权限
            List<SiteVO> userSites = siteMapper.findUserSites(temperatureDTO.getUserId());
