package com.zhixiangmain.impl.jygs.gszx;
...
import com.zhixiangmain.api.service.jygs.gszx.CompanyInformationService;
...
import com.zhixiangmain.dao.jygs.gszx.CompanyInformationMapper;
 ...
 * @Package com.zhixiangyun.impl.jygs.gszx
 * @Description: ${todo}
 * @author: hhp
...
public class CompanyInformationServiceImpl implements CompanyInformationService{
    ...
    @Override
    public ResultBean getCompanyInformations(CompanyInformationDTO companyInformationDTO, Integer page, Integer limit, JSONObject jobj) {
