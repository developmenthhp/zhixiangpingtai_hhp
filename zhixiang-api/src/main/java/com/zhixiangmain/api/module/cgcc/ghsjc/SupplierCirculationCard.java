 ...
 * @Description: ${todo}
 * @author: hhp
 * @date: 2019-04-23 14:49
 * @Copyright: 2019 www.zhixiangyun.net Inc. All rights reserved.
 * 注意：本内容仅限于浙江智飨科技内部传阅，禁止外泄以及用于其他的商业目
 */
@Data
@ToString
@Table(name="suppliercirculationcard")
public class SupplierCirculationCard extends BaseEntity {
    //单位名称
    private String name;
    //法定代表人
    ...
    //供应商id
    private Integer supplierCirculationCardId;
    //餐饮流通证照片
