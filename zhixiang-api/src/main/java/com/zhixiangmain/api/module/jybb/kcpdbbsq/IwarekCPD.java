package com.zhixiangmain.api.module.jybb.kcpdbbsq;
 ...
 * @Package com.zhixiangyun.api.module.jybb.kcpdbbsq
 * @Description: ${todo}
 * @author: hhp
...
@Data
@ToString
@Table(name="iwarekcpd")
public class IwarekCPD extends BaseEntity {
    //库存id集合，
