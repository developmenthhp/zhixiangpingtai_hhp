package com.zhixiangmain.api.module.scgl.spszgl;
...
public class WarehousDetails extends BaseEntity {
    ...
    private Integer objectCardUnify;//物证是否统一 1.是    2.不是
}
