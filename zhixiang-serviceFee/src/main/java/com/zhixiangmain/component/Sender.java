...
public class Sender implements RabbitTemplate.ConfirmCallback, ReturnCallback {
	...
	public void sendServiceFeeMail(MailBean mailBean) {
		...
		//异步消息
		rabbitTemplate.convertAndSend(RabbitConstant.TOPICEXCHANGE_SERVICEFEE, RabbitConstant.SERVICE_FEE_KEY, mailBean, correlationId);
		logger.info("服务费到期提醒消息已经发送到交换机, 等待交换机接受..." +  mailBean.getReceiver());
